    ...
    <div className="example-page ">
      <div className=" container-fluid">
        <MediaQuery minWidth={991.98} >
          <h2 className=" text-dark ps-5 pt-4 mb-3">Examples</h2>
        </MediaQuery>
          ...
          <div className="row">
              <div className="col-12">
                ...
                <div className="btn-group mb-4" role="group" aria-label="Basic outlined">
                  <Link to="addNew" type="button" className="btn btn-outline-dark lh-1 py-lg-2 px-lg-4 fs-6">Add new images</Link>
                  <button type="button" className="btn btn-outline-dark lh-1 py-lg-2 px-lg-4 fs-6" onClick={onSelectAll}>Select All</button>
                  <button type="button" className="btn btn-outline-dark lh-1 py-lg-2 px-lg-4 fs-6" onClick={onDeselectAll}>Deselect All</button>
                  <button type="button" className="btn btn-outline-dark lh-1 py-lg-2 px-lg-4 fs-6" disabled={selectedAmount ? false : true} onClick={() => onDelete(selectedItems)}>Remove selected ({selectedAmount})</button>
                </div>
              </div>
            <div className="col-12">

              <div className="row rounded-3 mb-4 py-2 bg-dark">
                <div className="col-2 col-lg-1 border-end"><h5 className='text-center text-white m-0'>#</h5></div>
